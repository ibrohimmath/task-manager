<template>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M15 5L5 15" stroke="#54577A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M15 8.33333V5H11.6666" stroke="#54577A" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M5 11.6667V15.0001H8.33333" stroke="#54577A" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
    </svg>
</template>